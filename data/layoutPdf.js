export const saran = (doc, h, isCheckResultNegative) => {
  ...
  if(isCheckResultNegative) {
    doc.text('\u2022' + ' ' + 'Menerapkan PHBS (perilaku hidup bersih dan sehat: mencuci tangan, menerapkan etika batuk,', 45, hi+(15*2), { maxWidth: width/1.2 })
    doc.text('menggunakan masker, menjaga stamina) dan physical distancing', 50, hi+(15*2)+9)
  }
  else {
